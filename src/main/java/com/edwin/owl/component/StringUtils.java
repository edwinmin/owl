...
public class StringUtils {
    ...
    /**
     * Determines whether or not the sting 'searchIn' contains the string 'searchFor', disregarding case and leading
     * whitespace
     * 
    ...
    /**
     * Determines whether or not the string 'searchIn' contains the string 'searchFor', dis-regarding case starting at
     * 'startAt' Shorthand for a String.regionMatch(...)
     * 
     * @param searchIn the string to search in
